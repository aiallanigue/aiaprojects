    ...
    <v-container fluid>
        ...
        <v-row>
          ...
          <v-col cols="5">
            <div style="position: relative; z-index: 9999" class="mt-16">
              <v-img src="por1.jpg" contain max-height="300"></v-img>
            </div>
          </v-col>
        </v-row>
      </div>
      <v-col cols="12" class="mt-16" id="about">
        <div>
          <v-row>
            <v-col cols="12" sm="6">
              <div class="egg">
                <v-img src="por2.jpg" max-height="300" class=""></v-img>
              </div>
            </v-col>
            <v-col cols="12" sm="6">
      ...
      <v-col cols="12" sm="12" id="services">
        <div class="d-flex justify-center mb-6">
          <v-btn color="#ff3535" class="mr-2">All</v-btn>
      ...
      <v-col cols="12" sm="12">
        <div class="d-flex justify-center mb-6">
          <v-btn color="#ff3535" class="mt-4">Load More</v-btn>
        </div>
      </v-col>
          ...
          <v-row>
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                <v-img src="por10.jpg" height="200px" cover></v-img>
            ...
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                <v-img src="por11.jpg" height="200px" cover></v-img>
            ...
            <v-col cols="12" sm="4">
              <v-card class="mx-auto" max-width="344" height="">
                <v-img src="por12.jpg" height="200px" cover></v-img>
      ...
      <v-col cols="12" id="biog">
        <div class="hire">
          <v-row>
            ...
            <v-col cols="12" sm="4">
              <v-btn color="#ff3535" class="mt-15">Hire Me</v-btn>
            </v-col>
          </v-row>
        </div>
      </v-col>
          ...
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              <v-btn
                ...
                class="mt-10"
                variant="outlined"
                href="https://www.google.com/maps/@14.4255308,121.0449762,15z"
                target="_blank"
              ></v-btn
              ><br />
              <span class="text-caption">Manila, Philippines</span
              ><br />
              <v-btn
              ...
              ></v-btn
              ><br />
              <span class="text-caption">+639178276302</span> <br />
              <v-btn
                icon="fas fa-envelope"
                color=""
                class="mt-10"
                variant="outlined"
                href="allanallanigue@gmail.com"

              ></v-btn
              ><br />
              <span class="text-caption">allanallanigue@gmail.com</span> <br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
            ...
            <v-textarea
              ...
              variant="outlined"
            ></v-textarea>
            <v-btn color="#ff3535" class="mt-2">Submit Now</v-btn>
          </v-col>
        </v-row>
      </v-col>
    </v-container>
